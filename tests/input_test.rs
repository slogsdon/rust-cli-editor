...
fn window_input_event_from_crossterm_event_handles_key_event() {
    ...
    let event = WindowInputEvent::from_crossterm_event(Event::Key(crossterm_event));
...
fn window_input_event_from_crossterm_event_handles_mouse_event() {
    ...
    let event = WindowInputEvent::from_crossterm_event(Event::Mouse(crossterm_event));
...
fn window_input_event_from_crossterm_event_handles_resize_event() {
    ...
    let event = WindowInputEvent::from_crossterm_event(crossterm_event);
